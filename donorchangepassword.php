...
function validateform()
{
	...
	{
		document.getElementById("erropassword").innerHTML = "Please enter the old password";
		i = 1;
	}
	if(document.getElementById("password").value=="")
	{
		document.getElementById("errpassword").innerHTML = "Please enter the new password";
		i = 1;
	}
		
	if(document.getElementById("confirmpassword").value=="")
	{
		document.getElementById("errconfirmpassword").innerHTML = "Please confirm password";
		i = 1;
	}
	if(i == 0)
	{
