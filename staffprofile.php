...
<img class="media-object" src="img/stafflogo.jpg"  style="width: 100px;height: 100px;">
</div>
...
function validateform()
{
	...
	{
		document.getElementById("errstaff_type").innerHTML = "Kindly select Category.";
		i=1;
	}
	if(document.getElementById("staff_name").value == "")
	{
		document.getElementById("errstaff_name").innerHTML = "Name should not be empty.";
		i=1;
	}
